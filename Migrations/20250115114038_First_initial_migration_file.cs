...
{
    /// <inheritdoc />
    public partial class First_initial_migration_file : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Email_Send = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Email_Password = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Email_Username = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Email_Port = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Email_Smtp = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HotelRates", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Main_picture = table.Column<bool>(type: "bit", nullable: false),
                    HotelId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CountReservation = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HotelInfoes_Beds_BedId",
                        column: x => x.BedId,
                        principalTable: "Beds",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HotelInfoes_HotelRates_RateId",
                        column: x => x.RateId,
                        principalTable: "HotelRates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HotelInfoes_Hotels_HotelId",
                        column: x => x.HotelId,
                        principalTable: "Hotels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HotelInfoes_Province_ProvinceId",
                        column: x => x.ProvinceId,
                        principalTable: "Province",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HotelInfoes_Rooms_RoomId",
                        column: x => x.RoomId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BankRefrenceNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Orders_Reservations_ResevationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HotelInfoes_BedId",
                table: "HotelInfoes",
                column: "BedId");

            migrationBuilder.CreateIndex(
                name: "IX_HotelInfoes_HotelId",
                table: "HotelInfoes",
                column: "HotelId");

            migrationBuilder.CreateIndex(
                name: "IX_HotelInfoes_ProvinceId",
                table: "HotelInfoes",
                column: "ProvinceId");

            migrationBuilder.CreateIndex(
                name: "IX_HotelInfoes_RateId",
                table: "HotelInfoes",
                column: "RateId");

            migrationBuilder.CreateIndex(
                name: "IX_HotelInfoes_RoomId",
                table: "HotelInfoes",
                column: "RoomId");
